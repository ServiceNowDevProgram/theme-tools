...
const getBaseIndex = (hex, totalVariations, startIndex) => {
...
export const generateColorScale = ({
	...
	if (totalVariations) {
		baseIndex = getBaseIndex(color, totalVariations, startIndex);
		darkVariations = baseIndex === 0 || baseIndex === 1 ? 0 : baseIndex - 1;
		lightVariations = totalVariations - baseIndex;
	}
...
export const getBestTextColor = (bgColor, lightColor, darkColor) => {
...
export const getNavHooksFromBrandPrimary = (brandPrimary) => {
	...
	const primary = getPrimary(brandPrimary);
	const secondary = getSecondary(brandSecondary);
